...
public class Security {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            // Permitir acesso sem autenticação às rotas relacionadas às postagens
            .authorizeHttpRequests(authz -> authz
                .requestMatchers("/postagens", "/postagens/{id}", "/postagens/titulo/**").permitAll()  // Permite o acesso sem autenticação para /postagens, /postagens/{id}, e /postagens/titulo/{titulo}
                ...
                // Permitir acesso sem autenticação às rotas de TemaController
                .requestMatchers("/temas", "/temas/{id}", "/temas/descricao/**").permitAll()  // Permite acesso a temas sem autenticação
